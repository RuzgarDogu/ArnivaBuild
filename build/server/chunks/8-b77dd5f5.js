...
const file = '_app/immutable/entry/(pages)-(admin)-(home)-dashboard-page.svelte.7fef89ad.js';
const server_id = "src/routes/(pages)/(admin)/(home)/dashboard/+page.server.ts";
const imports = ["_app/immutable/entry/(pages)-(admin)-(home)-dashboard-page.svelte.7fef89ad.js","_app/immutable/chunks/index.e58ce54e.js","_app/immutable/chunks/Chart.c7db6c32.js"];
const stylesheets = [];
const fonts = [];

export { component, file, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=8-b77dd5f5.js.map
