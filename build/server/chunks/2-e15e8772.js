...
const file = '_app/immutable/entry/(pages)-layout.svelte.31f1b282.js';
const server_id = "src/routes/(pages)/+layout.server.ts";
const imports = ["_app/immutable/entry/(pages)-layout.svelte.31f1b282.js","_app/immutable/chunks/index.e58ce54e.js"];
const stylesheets = [];
const fonts = [];

export { component, file, fonts, imports, index, _layout_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=2-e15e8772.js.map
