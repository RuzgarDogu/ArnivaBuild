...
const file = '_app/immutable/entry/(pages)-(guide)-sales-_id_-page.svelte.d639caf0.js';
const server_id = "src/routes/(pages)/(guide)/sales/[id]/+page.server.ts";
const imports = ["_app/immutable/entry/(pages)-(guide)-sales-_id_-page.svelte.d639caf0.js","_app/immutable/chunks/index.3c704159.js"];
const stylesheets = [];
const fonts = [];

export { component, file, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=14-0add2a26.js.map
