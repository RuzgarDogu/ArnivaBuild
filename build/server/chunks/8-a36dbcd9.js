...
const file = '_app/immutable/entry/(pages)-(admin)-(home)-dashboard-page.svelte.41d8d939.js';
const server_id = "src/routes/(pages)/(admin)/(home)/dashboard/+page.server.ts";
const imports = ["_app/immutable/entry/(pages)-(admin)-(home)-dashboard-page.svelte.41d8d939.js","_app/immutable/chunks/index.3c704159.js","_app/immutable/chunks/Chart.1eb2c688.js"];
const stylesheets = [];
const fonts = [];

export { component, file, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=8-a36dbcd9.js.map
